class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        // 100 tiles wide and 25 tiles tall.
        this.map = this.add.tilemap("candylevel", 18, 18, 100, 25);

        // Add a tileset to the map
        // First parameter: name we gave the tileset in Tiled
        // Second parameter: key for the tilesheet (from this.load.image in Load.js)
        this.tileset = this.map.addTilesetImage("candy_packed", "candy_packed");

        // Create a layer
        this.backround = this.map.createLayer("backround-layer", this.tileset, 0, 0);
...
1
        ...
        my.sprite.player = this.physics.add.sprite(50, 0, "platformer_characters", "tile_0000.png");
        ...
        this.physics.add.overlap(my.sprite.player, this.flagGroup, (obj1, obj2) => {
            ...
            this.wintext = this.add.text(1100, 200, 'You win. R To Restart', {fontSize: '48px'});
        });
